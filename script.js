...
const t = {
  en: {
    ...
    'about.p3': 'Based in Twente and active throughout Overijssel — from Almelo to Zwolle, from Enschede to Deventer. Perfect for festivals, corporate parties, club nights, or any occasion that deserves an upgrade from a Spotify playlist.',
    'about.party': 'Party',
  ...
  nl: {
    ...
    'about.p3': 'Thuis in Twente en actief door heel Overijssel — van Almelo tot Zwolle, van Enschede tot Deventer. Perfect voor festivals, bedrijfsfeesten, clubavonden of elk evenement dat een upgrade van een Spotify-playlist verdient.',
    'about.party': 'Feest',
